  ...
  >
   ...
   >
    ...
    >
     ...
     <!-- text  -->
     <a class="text-sm text-gray-400" href="mailto:info@zaman.co.ke">
   ...
   <div class="flex items-center py-5">
    ...
    <div class="flex-grow flex justify-end items-center gap-5">
     ...
     <div class="flex-grow flex justify-end items-center gap-5">
      ...
      <NuxtLink to="/menu/" class="text-lg border-button font-Lexend">
       Menu
      </NuxtLink>
     ...
     <div class="flex justify-end items-center gap-5">
      <a href="mailto:info@zaman.co.ke" class="text-lg font-Lexend hover:">
